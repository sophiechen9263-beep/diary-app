...
> 说明：当前版本已接入 LeanCloud，用于云端存储日记内容，实现跨设备访问。
...
**Q: 功能不工作？**  
A: 确保：
- `index.html` 中的 `<script src="https://cdn.jsdelivr.net/npm/leancloud-storage@4.13.2/dist/av-min.js"></script>` 存在  
- `index.html` 中的 `<script src="script.js"></script>` 存在  
- 浏览器联网，以便访问 LeanCloud  
